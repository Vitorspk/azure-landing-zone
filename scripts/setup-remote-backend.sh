...
echo -e "${GREEN}terraform init -migrate-state${NC}"
echo ""
echo "3. Commit the backend.tf files:"
echo -e "${GREEN}git add terraform/*/backend.tf${NC}"
echo -e "${GREEN}git commit -m \"feat: add remote state backend configuration\"${NC}"
echo ""
